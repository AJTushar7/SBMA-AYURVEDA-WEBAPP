...
export class CertificationsComponent {
  certifications: Certification[] = [
    {
      title: 'GMP Certified',
      description: 'Good Manufacturing Practice certification ensures our products meet strict quality standards',
    ...
    },
    {
      ...
      description: 'Food Safety and Standards Authority of India validation for safe consumption',
      icon: 'fa-shield'
    },
    {
